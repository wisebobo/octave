...
Z2 = A1 * Theta1';                        %5000 x 25   Theta1 25 x 401
A2 = [ones(m, 1) sigmoid(Z2)];            %5000 x 26
Z3 = A2*Theta2';                          %5000 x 10   Theta2 10 x 26
...
Delta_1 = Delta_1 + Sigma2' * A1;         %25 x 401  <-- 5000 x 25' * 5000 x 401
Delta_2 = Delta_2 + Sigma3' * A2;         %10 x 26   <-- 5000 x 10' * 5000 x 26
